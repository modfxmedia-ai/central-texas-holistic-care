...
const SERVICES: readonly Service[] = [
  {
    ...
    title: "Comprehensive Gynecological Exams for Women's Health",
...
export default function WomenPageClient() {
  return (
    <>
      <HeroSection />
      <ServicesSection />
  ...
  return (
    <section className="relative isolate w-full overflow-hidden bg-gradient-to-br from-[#0f2706] via-[#1a3a0a] to-[#0b1d04] py-24 sm:py-28 lg:py-32">
      ...
      >
        ...
        <rect width="100%" height="100%" fill="url(#women-hero-grid)" />
      </svg>
      <div
        aria-hidden
      ...
      >
        ...
        >
          ...
          <span className="text-white/90">Women</span>
        </motion.nav>
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          <div className="inline-flex items-center gap-2 rounded-full border border-[#1a3a0a]/15 bg-[#f0f5eb] px-4 py-1.5 text-[11px] font-semibold uppercase tracking-[0.3em] text-[#1a3a0a]">
            <Flower2 className="size-3.5 text-[#6CBE45]" />
            Services for Women
          </div>
          <h2
          ...
          >
            Care that meets you{" "}
            <span className="italic text-[#8a6f30]">where you are.</span>
          </h2>
        </div>
...
function ServiceCard({
  ...
  return (
    <motion.article
      variants={fadeUp}
      className="group relative flex h-full flex-col overflow-hidden rounded-3xl border border-[#C4A862]/25 bg-gradient-to-b from-white to-[#faf6ec] shadow-[0_24px_70px_-40px_rgba(15,39,6,0.35)] transition-all hover:-translate-y-1 hover:shadow-[0_36px_90px_-40px_rgba(15,39,6,0.5)]"
    >
      <span
        aria-hidden
      ...
      <div className="relative flex flex-1 flex-col px-6 py-7 sm:px-7 sm:py-8">
        <h3
          className="font-heading font-semibold leading-[1.2] text-[#0f2706]"
  ...
  return (
    <section className="relative isolate w-full overflow-hidden bg-gradient-to-br from-[#0f2706] via-[#1a3a0a] to-[#0b1d04] py-20 sm:py-24">
      ...
      >
        ...
        >
          Honest answers, a clear plan, and care built around your labs, your
          cycle, and your life stage.
        </motion.p>
