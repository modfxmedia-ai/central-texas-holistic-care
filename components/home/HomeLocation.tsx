          ...
          <div className="grid lg:grid-cols-5">
            ...
            <div className="relative lg:col-span-3">
              <div className="relative h-[260px] w-full sm:h-[300px] lg:h-full lg:min-h-[340px]">
                ...
                {/* Get Directions button overlay, bottom-right on the map */}
                <a
                  href={DIRECTIONS_URL}
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                >
                  <Navigation className="h-4 w-4 text-[#6CBE45]" strokeWidth={2.2} />
                  <span>Get Directions</span>
                  <ArrowUpRight
                    className="h-3.5 w-3.5 text-[#1a3a0a] transition group-hover:-translate-y-0.5 group-hover:translate-x-0.5"
                    strokeWidth={2.2}
                  />
                </a>
              </div>
