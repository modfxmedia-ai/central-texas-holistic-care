  ...
  products: {
    ...
    schema: [
      ...
      },
      {
        ...
        name: "Supplements",
        itemListElement: [
          { "@type": "Product", name: "ADK", offers: { "@type": "Offer", price: "37.50", priceCurrency: "USD" }, url: `${SITE_URL}/product/adk/` },
          { "@type": "Product", name: "BPC-157", offers: { "@type": "Offer", price: "10.00", priceCurrency: "USD" }, url: `${SITE_URL}/product/bpc-157/` },
          { "@type": "Product", name: "Complete Mag", offers: { "@type": "Offer", price: "32.99", priceCurrency: "USD" }, url: `${SITE_URL}/product/complete-mag/` },
          { "@type": "Product", name: "Curcumin Support", offers: { "@type": "Offer", price: "46.99", priceCurrency: "USD" }, url: `${SITE_URL}/product/curcumin-support/` },
          { "@type": "Product", name: "Dream Tea", offers: { "@type": "Offer", price: "30.00", priceCurrency: "USD" }, url: `${SITE_URL}/product/dream-tea/` },
          { "@type": "Product", name: "EvexiPEL Complete", offers: { "@type": "Offer", price: "99.99", priceCurrency: "USD" }, url: `${SITE_URL}/product/evexipel-complete/` },
          { "@type": "Product", name: "Glutaryl", offers: { "@type": "Offer", price: "99.00", priceCurrency: "USD" }, url: `${SITE_URL}/product/glutaryl/` },
          { "@type": "Product", name: "IMMUNE CHARGE® 100 ML", offers: { "@type": "Offer", price: "95.00", priceCurrency: "USD" }, url: `${SITE_URL}/product/immune-charge-100-ml/` },
          { "@type": "Product", name: "IMMUNE CHARGER THROAT SPRAY", offers: { "@type": "Offer", price: "46.99", priceCurrency: "USD" }, url: `${SITE_URL}/product/immune-charger-throat-spray/` },
          { "@type": "Product", name: "KOI CBD", offers: { "@type": "Offer", price: "70.00", priceCurrency: "USD" }, url: `${SITE_URL}/product/koi-cbd/` },
          { "@type": "Product", name: "Methyl Support", offers: { "@type": "Offer", price: "57.99", priceCurrency: "USD" }, url: `${SITE_URL}/product/methyl-support/` },
          { "@type": "Product", name: "Sleep Gummies", offers: { "@type": "Offer", price: "45.00", priceCurrency: "USD" }, url: `${SITE_URL}/product/sleep-gummies/` },
          { "@type": "Product", name: "Thyroid Support", offers: { "@type": "Offer", price: "49.99", priceCurrency: "USD" }, url: `${SITE_URL}/product/thyroid-support/` },
          { "@type": "Product", name: "Turmeric Latte Mix", offers: { "@type": "Offer", price: "30.00", priceCurrency: "USD" }, url: `${SITE_URL}/product/turmeric-latte-mix/` },
        ],
      },
    ],
    bodyContent: [
